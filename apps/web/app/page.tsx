      ...
      <MotionSection className="grid min-h-[calc(100vh-88px)] items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-2 lg:gap-12 lg:px-8 lg:py-24">
        <div>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="/shop"
              className="inline-flex flex-1 items-center justify-center rounded-md bg-primary px-8 py-4 text-sm font-black uppercase tracking-[0.18em] text-white sf-red-glow-box"
            >
              Shop Now
            </Link>
            <Link
              href="/about"
              className="inline-flex flex-1 items-center justify-center rounded-md border border-black/10 px-8 py-4 text-sm font-bold uppercase tracking-[0.18em] text-foreground transition-colors hover:bg-black/5 dark:border-white/10 dark:hover:bg-white/5"
            >
              Learn More
            </Link>
          </div>
